...
imwrite(watermarked, 'dct watermarked after noise pepeer.jpg');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5555

%% Create a binary matrix to store the extracted watermark
water_extracted = zeros(120, 120);
watermarkedImage_noise = imnoise(watermarked, 'poisson');
...
for i = 1:120 
    for j = 1:120 
        ...
        %% Choose a, b for the equation
        b = 2.5; % Adjusted the value of b for better results
        if watermarked_binary(i, j) == 1
            a = 1;
        else 
            a = -1;
...
dct_extrectimage =original;
%% display extracted watermark
figure,imshow(dct_extrectimage), title('extract noise ');

%% store the extracted image in new name is extracted image 
imwrite(dct_extrectimage, 'dct extracted after noise pepeer .jpg');
